...
$stmt = $pdo->prepare("SELECT a.id, a.appointment_date, a.appointment_time, a.status, a.meeting_link,
                      u.name as patient_name, p.date_of_birth, p.gender
                      FROM appointments a
        ...
        <div class="container-fluid py-4">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="doctorschedule.php" class="d-none d-sm-inline-block btn btn-primary shadow-sm">
                    <i class="fas fa-calendar-plus mr-2"></i> Manage Schedule
                </a>
            </div>
                    ...
                    <?php if (empty($upcomingAppointments)): ?>
                        <div class="card shadow">
                            <div class="card-body text-center py-5">
                                ...
                                <p class="text-muted">Manage your schedule to get more appointments</p>
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="row">
                                    ...
                                    <div class="card appointment-card h-100">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-start mb-3">
                                                <div>
                                                    ...
                                                    <p class="text-muted mb-2">
                                                        ...
                                                        $now = new DateTime();
                                                        $age = $now->diff($dob)->y;
                                                        echo $age . ' years, ' . ucfirst($appointment['gender']);
                                                        ?>
                                                    </p>
                                                </div>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <?php elseif ($appointment['status'] == 'confirmed' && !empty($appointment['meeting_link'])): ?>
                                                    <a href="<?= htmlspecialchars($appointment['meeting_link']) ?>" 
                                                       class="btn btn-primary" target="_blank">
                                                        <i class="fas fa-video mr-2"></i> Start Consultation
                                                    </a>
                                                <?php endif; ?>
                                                ...
                                                <?php if ($appointment['status'] == 'confirmed'): ?>
                                                    <form method="POST" action="">
                                                        <input type="hidden" name="appointment_id" value="<?= $appointment['id'] ?>">
                                                        <button type="submit" name="complete_appointment" class="btn btn-info">
