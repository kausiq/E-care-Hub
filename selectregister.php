...
<head>
    ...
    <title>Register | E Care Hub</title>
...
<body>
    <div class="registration-container">
        <div class="registration-header">
            <h2><i class="fas fa-heartbeat me-2"></i>E Care Hub Registration</h2>
        ...
        <div class="role-selection">
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-3">
                    <a href="patientregistration.php" class="role-card">
                        <div class="role-icon">
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="doctorregistration.php" class="role-card">
                        <div class="role-icon">
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="donorregistration.php" class="role-card">
                        <div class="role-icon">
                            <i class="fas fa-tint" style="font-size: 40px;color:#DC3545;"></i>
                        </div>
                        <h4>Blood Donor</h4>
                        <p>Register to help save lives</p>
                    </a>
                </div>
                <div class="col-md-6 col-lg-3">
                    <a href="ambulanceregistration.php" class="role-card">
                        <div class="role-icon">
