...
// Get payment history
$stmt = $pdo->prepare("SELECT p.id, p.amount, p.payment_method, p.payment_status, p.payment_date, 
                      a.appointment_date, u.name as doctor_name, d.specialty
                      FROM payments p
...
<head>
    ...
    <title>Payment History - E Care Hub</title>
...
<body>
    ...
    <div class="container-fluid py-4">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Payment History</h1>
        </div>
        ...
        <?php if (empty($payments)): ?>
            <div class="card shadow">
                <div class="empty-state">
                    ...
                    <p class="text-muted">Your payment records will appear here after consultations</p>
                </div>
            </div>
        <?php else: ?>
            <div class="card shadow">
                            ...
                            <tbody>
                                <?php foreach ($payments as $payment): ?>
                                    <tr>
                                        ...
                                        <td>Dr. <?= htmlspecialchars($payment['doctor_name']) ?></td>
                                        <td><?= date('M j, Y', strtotime($payment['appointment_date'])) ?></td>
                                        ...
                                        <td>
                                            <a href="paymentreceipt.php?id=<?= $payment['id'] ?>" class="btn btn-sm btn-primary">
